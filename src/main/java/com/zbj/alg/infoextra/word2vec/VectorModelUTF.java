package com.zbj.alg.infoextra.word2vec;
...
public class VectorModelUTF {
     ...
     * */
    public VectorModelUTF(Map<String, float[]> wordMap, int vectorSize){
     ...
     * @return 词向量模型
     */
    public static VectorModelUTF loadFromFile(String path){
...
//            layerSizeLoaded = dis.readInt();
        ...
        return new VectorModelUTF(wordMapLoaded, layerSizeLoaded);
